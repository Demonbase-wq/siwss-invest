        ...
        <div className="px-4 flex flex-col gap-12">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-white text-center w-auto lg:w-[480px] my-0 mx-auto">
              With SwissPipsAI, your investments are managed with precision,
              offering secure and transparent growth opportunities. Harness the
              power of our cutting-edge AI to achieve the ROI you deserve.
            </p>
          </div>
