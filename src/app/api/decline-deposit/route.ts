import { transactions, users, deposits } from "@/lib/airtable";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    await deposits.update(id, { status: "Declined" });
    ...
    const date = deposit?.fields.date as string;
...
<head>
    ...
    <title>Deposit Request Declined</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Dear ${name},</p>
            <p>We regret to inform you that your recent deposit request has been declined. Here are the details of the declined deposit:</p>
